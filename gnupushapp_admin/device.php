...
<?php                     
    for ($i=1; $i<=10; $i++) {
			$sql = "select * from g5_mblevel where gm_id = '$i'";
			$gmData = sql_fetch($sql);
...
?>                     
		...
		<form action="device_proc.php" id="pushform" method="post" enctype="multipart/form-data">
							...
							<div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
								<ul class="pagination">
									<li class="paginate_button previous <?php if($page == 1) {?>disabled<?php } ?>">
										<a href="<?php echo G5_URL.'/gnupushapp_admin/device.php?'.$qstr.'1'; ?>">◀◀</a>
									</li>
									<li class="paginate_button previous <?php if($page == 1) {?>disabled<?php } ?>">
										<a href="<?php echo G5_URL.'/gnupushapp_admin/device.php?'.$qstr.($page-1); ?>">Previous</a>
									</li>
									...
									<li class="paginate_button <?php if($page == $now_number) {?>active<?php } ?>">
										<a href="<?php echo G5_URL.'/gnupushapp_admin/device.php?'.$qstr.$now_number; ?>" ><?php echo $now_number ?></a>
									</li>
									<?php } ?>
									<li class="paginate_button next <?php if($page == $total_page) {?>disabled<?php } ?>" id="example2_next">
										<a href="<?php echo G5_URL.'/gnupushapp_admin/device.php?'.$qstr.($page+1); ?>" >Next</a>
									</li>
									<li class="paginate_button next <?php if($page == $total_page) {?>disabled<?php } ?>">
										<a href="<?php echo G5_URL.'/gnupushapp_admin/device.php?'.$qstr.$total_page; ?>" >▶▶</a>
									</li>
								</ul>
							</div>
							</center>
