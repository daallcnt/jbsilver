...
<article id="bo_v" style="width:<?php echo $width; ?>;font-size:13px;">
    <header>
        <h2 id="bo_v_title">
...
<div class="tbl_frs01 tbl_wrap">
    <table>
                    <colgroup>
                        ...
                        <col width="35%">
                        <col width="15%">
                        <col width="35%" class="tbl_frs02">                        
                    </colgroup>
    <tbody>
    <tr>
        <th scope="row">회사명</th>
        <td colspan="3"><?php echo $wr1[0]?></td>
    </tr>
    <tr>
        <th scope="row">대표자</th>
...
?>        
    ...
    <tr>
        ...
        <td colspan="3"><?php echo $wr3[0]?></td>
    </tr>
    <tr>
        <th scope="row">회사주소</th>
        <td colspan="3"><?php echo sprintf("(%s)", $wr2[0]).' '.print_address($wr2[1], $wr2[2], $wr2[3], ""); ?></td>
    </tr>
  
    <?php if($is_admin && $wr1[2]){?>         
    <tr>
        <th scope="row">회사전화</th>
        <td colspan="3"><?php echo $wr1[2]?></td>
    </tr>
    <?php }?>             
    <tr>
    ...
    <tr>
        ...
        <td colspan="3"><?php echo number_format($wr8[0])?>명</td>
    </tr>
    <tr>
...
<?php if($wr9[4]=='on') { ?>주간<?php } ?><?php if($wr9[5]=='on') { ?>2교대<?php } ?><?php if($wr9[6]=='on') { ?>3교대<?php } ?>&nbsp;시간(&nbsp;<?php echo $wr9[7]?>&nbsp;~&nbsp;<?php echo $wr9[8]?>&nbsp;)		
    ...
    <tr>
        ...
        <td colspan="3">구직등록자 : 전화문의, 미등록자 : 직접방문후 상담</td>
    </tr>
    <tr>
...
<?php if($wr2[4]=='on') { ?>고용보험<?php } ?>&nbsp;&nbsp;<?php if($wr2[5]=='on') { ?>산재보험<?php } ?>&nbsp;&nbsp;<?php if($wr2[6]=='on') { ?>건강보험<?php } ?>&nbsp;&nbsp;<?php if($wr2[7]=='on') { ?>연금보험<?php } ?>        
    ...
    <tr>
        ...
        <td colspan="3"><?php echo $wr3[3]?></td>
    </tr> 
    <tr>
        <th scope="row">상세조건</th>
        <td colspan="3"><div id="bo_v_con"><?php echo get_view_thumbnail($view['content']); ?></div></td>
    </tr>     
    <tr>
    ...
    <tr>
        <th scope="row">담당자</th>
        <td colspan="3"><?php if($wr1[1]){?><?=$wr1[1]?><?php }else{?>전북노인일자리센터<?php }?></td>
    </tr>
     <tr>
        <th scope="row">문의처</th>
        <td colspan="3"><?php echo $wr5[2]?> &nbsp; <?php echo ($wr1[4])?" FAX : $wr1[4]":""; ?>&nbsp;&nbsp;&nbsp;&nbsp;이메일 : <?php echo $wr1[3];?></td>
    </tr>    
    <!--tr>
        <th scope="row">연락처</th>
        <td colspan="3"><?php if($is_admin){?><?php echo $wr1[2]?> <?php echo ($wr1[4])?"	FAX : $wr1[4]":""; ?>&nbsp;&nbsp;&nbsp;&nbsp;이메일 : <?php echo $wr1[3];?><br /><?php }?>
        전북노인일자리센터 : 063-255-9112, 063-273-2086</td>
    </tr-->                                              
    </tbody>
    </table>
</div>
