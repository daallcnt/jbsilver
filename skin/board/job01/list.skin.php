...
?>             
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <li><button type="submit" name="btn_submit" value="선택채용완료" onclick="document.pressed=this.value" class="btn btn_admin"><i class="fa fa-files-o" aria-hidden="true"></i> 선택채용완료</button></li>
