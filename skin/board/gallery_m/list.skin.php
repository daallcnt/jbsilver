...
?>                              
                    ...
                    <div class="gall_name">
                        <span class="profile_img">업종 : <?php echo $list[$i]['wr_1'] ?></span>
                    </div>
                    <div class="gall_name">
                        <span class="profile_img">주소 : <?php echo $list[$i]['wr_content'] ?></span>
                    </div>
                <?php if($list[$i]['wr_link1']){ ?>   
                    <div class="gall_name">
                        <span class="profile_img"><a href="<?php echo set_http($list[$i]['wr_link1'])?>" target="_blank"><?php echo $list[$i]['wr_link1']?></a></span>
                    </div>
                <?php }?>                                            
                </div>
            </div>
    ...
    <fieldset id="bo_sch">
        ...
        <select name="sfl" id="sfl">
            ...
            <option value="wr_content"<?php echo get_selected($sfl, 'wr_content'); ?>>주소</option>
        </select>
