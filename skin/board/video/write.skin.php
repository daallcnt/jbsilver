...
<section id="bo_w">
    ...
    <div class="write_div">
        ...
        <input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="frm_input full_input" size="30" placeholder="유튜브"> <span style="color:#777;">※ http://www.youtube.com/embed/ 뒷부분</span>
    </div>
    <div class="write_div">
        <label for="wr_2" class="sound_only">비메오</label>
        <input type="text" name="wr_2" value="<?php echo $write['wr_2']?>" id="wr_2" class="frm_input full_input" size="30" placeholder="비메오"> <span style="color:#777;">※ http://player.vimeo.com/video/ 뒷부분</span>
    </div>
    <div class="write_div">
    ...
    <div class="write_div">
        ...
        <input type="text" name="wr_4" value="<?php echo $write['wr_4']?>" id="wr_4" class="frm_input full_input" size="50" placeholder="동영상링크"> <br /><br /><span style="color:#777;">※ 동영상 링크 주소입력 (http:// 입력), 파일형식:mp4파일</span>
    </div>
