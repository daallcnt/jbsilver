...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
		...
		<div style="margin:0 0 10px 0;"> 
			<iframe width="<?php echo $v_width?>" height="<?php echo $v_height?>" src="https://www.youtube.com/embed/<?php echo $view[wr_1]?>?autoplay=1" frameborder="0" allowfullscreen></iframe>
		</div>
		<?php } ?>
