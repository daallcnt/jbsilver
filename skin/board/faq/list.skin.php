...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>; margin:0 auto">
	...
	<div class="list-title">
		<ul>
			...
			<li class="fd_num">번호</li>
			<li class="fd_title">제목</li>
		</ul>
	</div>
		 ...
		 ?>
			<li>
				...
				<div class="panel loading">
					...
					<span><?php echo cut_str($list[$i]['wr_content'], 500); ?></span>
					<?php //if ($is_admin == 'super' || $is_auth) {  ?>
					<span>
					<a href="<?php echo $list[$i]['href'] ?>" class="btn_admin">자세히보기</a>
					</span>
					<?php //}  ?>
				</div>
			</li>
