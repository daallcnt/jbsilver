...
?>                              
                    ...
                    <div class="gall_name">
                        <span class="profile_img">가격 : <?php echo ($list[$i]['wr_1'])?number_format($list[$i]['wr_1'])."원":""; ?></span>
                    </div>
                    <div class="gall_name">
                        <span class="profile_img">문의 : <?php echo $list[$i]['wr_2'] ?></span>
                    </div>
                <?php if($list[$i]['wr_link1']){ ?>   
                    <div class="gall_name" style="text-align:center;margin-top:15px;">
                        <span class="profile_img"><a href="<?php echo set_http($list[$i]['wr_link1'])?>" target="_blank"  class="btn_admin btn" style="border-radius:5px; padding:0 30px;">구매하기</a></span>
                    </div>
                <?php }?>                                            
                </div>
            </div>
