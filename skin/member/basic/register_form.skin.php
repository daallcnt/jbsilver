 ...
 <div id="register_form"  class="form_01">   
    <div>
        ...
        <ul>
            <li>
                ...
                <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="아이디(휴대폰번호)">
                <span id="msg_mb_id"></span>
                <span class="frm_info">휴대폰번호를 아이디로 숫자로만 입력하세요.</span>
            </li>
            <li>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
            ...
            <?php }*/  ?>
            <li>
                <label for="mb_1" class="sound_only">생년월일</label>
                <input type="text" name="mb_1" value="<?php echo $member['mb_1']?>" id="mb_1" required  class="frm_input  half_input required" size="10" placeholder="생년월일">
            </li>
        ...
        <?php }else{ ?>
        <input type="hidden" name="mb_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>">
        <input type="hidden" name="mb_addr1" value="<?php echo $member['mb_addr1']?>">
        <input type="hidden" name="mb_addr2" value="<?php echo $member['mb_addr2']?>">
        <input type="hidden" name="mb_addr3" value="<?php echo $member['mb_addr3']?>">
...
<div class="btn_confirm">
    ...
    <?php if($w == "u") {?>
    <a href="<?php echo G5_URL ?>/member/index.php?w=u&case=write" class="btn_b01" style="padding:15px">취업상담카드 수정</a>
    <a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=member_leave.php" onclick="return member_leave();" class="btn_b01" style="padding:15px">회원탈퇴</a>
	<?php }?>    
</div>
</form>
    ...
    <script>
$(function(){
    $("#mb_1").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yymmdd", showButtonPanel: true, yearRange: "c-99:c+99"/*, maxDate: "+0d"*/ });
});	
    $(function() {
