...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2">상담카드</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_grp" class="td_confirm" rowspan="2"><?php //echo $group ?>
        <a href="./card.php?case=view&amp;w=u&amp;mb_id=<?php echo $row['mb_id']?>" class="btn btn_03">상담카드</a>
        </td>
