...
$pg_anchor = '<ul class="anchor">
    ...
    <li><a href="#anc_cf_extra">메인영상</a></li>
</ul>';
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_extra">
                ...
                <label for="cf_1">영상주소</label>
                <input type="text" name="cf_1" value="<?php echo get_sanitize_input($config['cf_1']); ?>" id="cf_1" class="frm_input" size="50"> <span style="color:#777;">※ http://www.youtube.com/embed/ 뒷부분</span>
            </td>
        </tr>
        <?php //} ?>
        </tbody>
