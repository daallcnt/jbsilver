	...
	<script type="text/javascript">
		...
		<div class="stabs_container">	
			...
			<div class="stab_container">
				...
				<div id="stab2" class="stab_content"><?php echo latest("basic1", "sub06_01", 3, 22);?>	</div>	
				<!--<div id="stab3" class="stab_content"><?php echo jbba_api("http://www.jeonbuk.go.kr/board/openApi/rss.jeonbuk?boardId=JEONBUK_NOTICE",3,22,"DOM_000000102001001001")?></div>	-->
			</div>
		</div>	
