...
<a href="<?php echo $list_href ?>" class="btn_b01"><i class="fa fa-list" aria-hidden="true"></i> 목록</a>
...
<div class="tbl_frs01 tbl_wrap">
        ...
        <br />
<?php }?>
        <div id="bo_v_con"><?php echo ($board['bo_10'] == "ok")?$view['wr_content']:get_view_thumbnail($view['content']); ?></div>
...
<li><a href="<?php echo $list_href ?>" class="btn_list"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
    ...
    <?php
    // 코멘트 입출력
	if($bo_table == "sub06_01" || $bo_table == "sub06_04") {
	}else{
