...
<?php if($board['bo_8'] == "yes") {?>
    <div class="write_div">
        <label for="wr_1" class="sound_only">기관명<strong>필수</strong></label>
		<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input full_input required" maxlength="255" placeholder="기관명">                
    </div>
    <div class="write_div">
        <label for="wr_2" class="sound_only">연락처<strong>필수</strong></label>
		<input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input required" maxlength="255" placeholder="연락처">                
    </div>
    <div class="write_div">
        <label for="wr_3" class="sound_only">이메일</label>
		<input type="text" name="wr_3" value="<?php echo ($write['wr_3'])?$write['wr_3']:$member['mb_email'];?>" id="wr_3" class="frm_input email" maxlength="255" placeholder="이메일">                
    </div>        
<?php }?>
        <div class="write_div">
