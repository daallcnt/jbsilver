...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            ...
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="사업수행기관">
        </div>
    ...
    <div class="write_div">
        ...
        <input type="text" name="wr_3" value="<?php echo $write['wr_3']?>" id="wr_3" class="frm_input full_input" placeholder="주소">
    </div>       
