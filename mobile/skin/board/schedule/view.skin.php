...
<?php  
   $from_date = substr($view['wr_1'],0,4)."년 ".sprintf("%2d",substr($view['wr_1'],4,2))."월 ".sprintf("%2d",substr($view['wr_1'],6,2))."일 ";
   $to_date   = substr($view['wr_2'],0,4)."년 ".sprintf("%2d",substr($view['wr_2'],4,2))."월 ".sprintf("%2d",substr($view['wr_2'],6,2))."일 ";
?>         
...
<div class="tbl_frs01 tbl_wrap">
                    ...
                    <colgroup>
                        <col width="20%">
                        <col width="80%" class="tbl_frs02">                     
                    </colgroup>
                    <tbody>
                    <tr>
                        <th scope="row">시작일</th>
                        <td><?php echo $from_date?> <?php echo $view['wr_6']?></td>
                    </tr>
                    <tr>
                        <th scope="row">종료일</th>
                        <td><?php echo $to_date?> <?php echo $view['wr_7']?></td>
                    </tr> 
                    </tbody>
                    </table>
...
<div style="text-align:center;margin:30px 0"><a href="tel:063-255-9112" style="background:#ff0000;border-radius:5px;color:#ffffff;font-weight:bold;padding:10px 20px;font-size:13px;"><i class="fa fa-phone-square" aria-hidden="true"></i> 전화연결</a></div>
