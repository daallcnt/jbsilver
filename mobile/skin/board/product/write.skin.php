...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            <label for="wr_subject" class="sound_only">생산품<strong>필수</strong></label>
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="생산품">
        </div>

        <div class="write_div">
            <label for="wr_content" class="sound_only">기관명<strong>필수</strong></label>
            <input type="text" name="wr_content" value="<?php echo $content?>" id="wr_content" required class="frm_input full_input required" placeholder="기관명">
                    
        </div>
        <div class="write_div">
            <label for="wr_1" class="sound_only">가격</label>
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="frm_input full_input" placeholder="가격">
        </div>

    <div class="write_div">
        <label for="wr_2" class="sound_only">문의</label>
        <input type="text" name="wr_2" value="<?php echo $write['wr_2']?>" id="wr_2" class="frm_input full_input" placeholder="문의">
    </div>
        <div class="bo_w_link write_div">
            <label for="wr_link1"><i class="fa fa-link" aria-hidden="true"></i> <span class="sound_only">구매링크</span></label>
            <input type="text" name="wr_link1" value="<?php if($w=="u"){echo $write['wr_link1'];} ?>" id="wr_link1" class="frm_input wr_link">
        </div>
