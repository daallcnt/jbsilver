...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="bo_w_tit write_div">
            ...
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="기업명">
        </div>

        <div class="write_div">
            <label for="wr_content" class="sound_only">주소<strong>필수</strong></label>
            <input type="text" name="wr_content" value="<?php echo $content?>" id="wr_content" required class="frm_input full_input required" placeholder="주소">
                    
        </div>
        <div class="write_div">
            <label for="wr_1" class="sound_only">업종</label>
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="frm_input full_input" placeholder="업종">
        </div>


        <div class="bo_w_link write_div">
            <label for="wr_link1"><i class="fa fa-link" aria-hidden="true"></i> <span class="sound_only">홈페이지</span></label>
