    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            <div class="gall_li_wr">
                ...
                <div class="gall_img" style="border:1px solid #dddddd;">
                <?php
...
?>                    
                   ...
                   업종 : <?php echo $list[$i]['wr_1'] ?>
                   <br />주소 : <?php echo $list[$i]['wr_content'] ?>
                <?php if($list[$i]['wr_link1']){ ?>
                   <br /><a href="<?php echo set_http($list[$i]['wr_link1'])?>" target="_blank"><?php echo $list[$i]['wr_link1']?></a>
                <?php }?>
                </div>
            </div>
        </li>
