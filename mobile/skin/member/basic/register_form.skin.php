...
<div>
    ...
    <div class="form_01">
        ...
        <li>
            ...
            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?> placeholder="아이디(휴대폰번호)">
		...
		<span style="color:#ff0000;">※ 비밀번호는 영문, 숫자, 특수문자 조합 8~20자리로 조합해주세요</span>
    </div>
    ...
    <div class="form_01">
        ...
        <?php }*/ ?>
            <li>
                ...
                <input type="text" name="mb_1" value="<?php echo $member['mb_1']?>" id="mb_1"  class="frm_input  half_input" size="10" placeholder="생년월일">
            </li>
        <li style="display:none">
            <label for="reg_mb_email" class="sound_only">E-mail</label>
                ...
                <input type="email" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" class="frm_input email " size="50" maxlength="100" placeholder="E-mail">
    ...
    <?php if($w == "u") {?>
    <a href="<?php echo G5_URL ?>/member/index.php?w=u&case=write" class="btn btn_submit">취업상담카드</a>
    <?php }?>        
    </div>
    </form>
